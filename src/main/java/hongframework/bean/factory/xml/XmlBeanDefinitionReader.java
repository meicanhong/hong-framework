package hongframework.bean.factory.xml;

import cn.hutool.core.util.StrUtil;
import cn.hutool.core.util.XmlUtil;
import hongframework.bean.BeanException;
import hongframework.bean.factory.config.BeanDefinition;
import hongframework.bean.factory.config.BeanReference;
import hongframework.bean.factory.config.PropertyValue;
import hongframework.bean.factory.support.AbstractBeanDefinitionReader;
import hongframework.bean.factory.support.BeanDefinitionRegistry;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected void doLoadBeanDefintions(InputStream inputStream) throws ClassNotFoundException {
